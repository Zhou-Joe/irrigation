...
urlpatterns = [
    ...
    path('water-requests/', views.water_requests_list, name='water_requests'),
    path('water-requests/<int:pk>/update/', views.water_request_update, name='water_request_update'),
